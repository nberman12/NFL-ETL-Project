...
CREATE TABLE "players" (
    ...
    "POS" VARCAR(10)   NOT NULL,
    "Age" INT   NOT NULL,
    "HT" VARCAR(10)   NOT NULL,
    "WT" VARCAR(10)   NOT NULL,
    "Exp" VARCAR(10)   NOT NULL,
    "College" VARCAR(50)   NOT NULL,
    "FullName" VARCAR(50)   NOT NULL,
    "First_Name" VARCAR(50)   NOT NULL,
